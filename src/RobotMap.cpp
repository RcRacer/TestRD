...
std::shared_ptr<Solenoid> RobotMap::chassisSolenoid;
...
void RobotMap::init() {
    ...
    chassisCompressor.reset(new Compressor(1));
    
    
    chassisSolenoid.reset(new Solenoid(1, 1));
    lw->AddActuator("Chassis", "Solenoid", chassisSolenoid);
